...
public class AnswersTextRight : MonoBehaviour
{
    Text txt;
    int counter = 0;
    string story;
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            {
                StopAllCoroutines();
                txt.text = "EXPLAIN!?! EXPLAIN!?! EXPLAIN!?!";
                story = txt.text;
                txt.text = "";
                StartCoroutine("PlayText");
                counter = counter += 1;
